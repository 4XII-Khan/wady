...
- 参数化，支持指定参数项的参数化，实现参数的排列组合、顺序组合。
- 提供统一的数据驱动方法，支持测试类、测试方法名称在指定目录下自动加载对应的配置文件。
- 提供统一的测试用例入参格式。
- 提供统一灵活的结果比对方法，支持JsonObject、JsonArray、String、Integer等基本数据类型的精确、模糊比较。

**V2.0 即将支持的特性**

- 接口测试用例自动生成，通过解析Jar文件，自动生成各接口的测试代码。
- Yaml配置文件自动生成，根据各接口方法入参，生成配置文件。
...
![微信图片_20200606123847](C:\Users\HP\Desktop\微信图片_20200606123847.png)
...
**wady** 在对某些方法进行测试时，通常会使用不同的数据对方法进行覆盖，如边界值测试，YAML 多文档块实现了在一个yaml中，隔离不同测试数据的目的。
...
![微信图片_20200606123907](C:\Users\HP\Desktop\微信图片_20200606123907.png)
...
![image-20200608012744062](C:\Users\HP\AppData\Roaming\Typora\typora-user-images\image-20200608012744062.png)
...
![image-20200608012827661](C:\Users\HP\AppData\Roaming\Typora\typora-user-images\image-20200608012827661.png)
